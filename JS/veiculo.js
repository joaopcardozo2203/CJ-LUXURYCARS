...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (gridFrota) {
        gridFrota.innerHTML = frotaLuxo.map(carro => `
            <article class="card">
    ...
    if (vehiclePage) {
        ...
        // Atualiza Imagem
        const directImg = document.getElementById("vehicle-image") || document.getElementById("imgVeiculo");
        ...
        // Textos descritivos
        const eyebrow = document.getElementById("vehicle-category") || document.querySelector(".eyebrow");
        const title = document.getElementById("vehicle-title") || document.querySelector(".vehicle-content h1");
        const desc = document.getElementById("vehicle-description") || document.querySelector(".vehicle-description");
        ...
        const btnOrcamento = document.getElementById("whatsapp-button") || document.getElementById("btnOrcamento") || document.querySelector(".btn-whatsapp-large, .btn-primary");
        if (btnOrcamento) {
            btnOrcamento.href = `https://wa.me/?text=${encodeURIComponent('Olá! Gostaria de solicitar um orçamento exclusivo para o ' + carro.nome)}`;
